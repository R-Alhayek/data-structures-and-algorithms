...
const oddValues = (arr) => {
  // Solution code here...
  let oddNum = arr.filter(number => (number % 2) === 1);
  return oddNum;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let array = arr.filter(notIncluded => ! forbiddenValues.includes(notIncluded));
  return array;
};
