...
// Solution code here...
// arr.map((strItem) => {
// strItem.length > strElement.length ? strElement=strItem : strElement !== strItem;
// });
// return arr.indexof(strElement);
let strElement ='';
arr.map (str => {
  if (str.length > strElement.length)
    strElement = str;
...
const firstLetters = (arr) => {
  // Solution code here...
 let firstEl = arr.map(word => word.charAt(0));
 return firstEl;
...
const findHappiness = (arr) => {
  // Solution code here...
  return arr.filter((happyFace) => happyFace.includes(':)'));
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  let number = arr.map(newNum => newNum.substring(1,4) + newNum.substring(6,9) + newNum.substring(10,14));
  return number;
};
...
const allHappy = (arr) => {
  // Solution code here...
  let array = arr.every(str => str.includes(':)'));
  return array;
